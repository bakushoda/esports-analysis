...
class CorsiDataIntegratorHighschool:
    def __init__(self, data_dir="data"):
        """
        高校生向けCorsiタスクデータをdata_masterに統合するクラス
    ...
    def preprocess_corsi_data(self):
        ...
        # 必要な列のみを抽出
        corsi_columns = ['subjectId', 'ncorrecttotal', 'blockspan', 'totalscore']
        ...
        # subjectIdでソート
        self.corsi_processed = self.corsi_processed.sort_values(['subjectId'])
    ...
    def match_data_by_participant_id(self):
        ...
        for _, corsi_row in self.corsi_processed.iterrows():
            subject_id = corsi_row['subjectId']
    ...
    def save_updated_data(self):
        ...
        print("Corsi data integration completed successfully!")
    ...
    def generate_report(self):
        ...
        print("\n" + "="*50)
        print("CORSI DATA INTEGRATION REPORT (HIGHSCHOOL)")
        print("="*50)
    ...
    def run_integration(self):
        ...
        データ統合プロセス全体を実行
        """
        print("Starting Corsi data integration process (Highschool)...")
        print("="*50)
...
if __name__ == "__main__":
    ...
    integrator = CorsiDataIntegratorHighschool("data")
