...
class StroopDataIntegratorHighschool:
    def __init__(self, data_dir="data"):
        """
        高校生向けStroopタスクデータをdata_masterに統合するクラス
        ...
        self.stroop_file = os.path.join(data_dir, "cognitive", "tiger_2024yobijikken_stroopwithcontrolkeyboard(ja)_summary_2509281347.xlsx")
    ...
    def preprocess_stroop_data(self):
        ...
        # 必要な列のみを抽出
        stroop_columns = ['subjectId', 'propcorrect', 'meanRT']
        ...
        # subjectIdでソート
        self.stroop_processed = self.stroop_processed.sort_values(['subjectId'])
    ...
    def match_data_by_participant_id(self):
        ...
        for _, stroop_row in self.stroop_processed.iterrows():
            subject_id = stroop_row['subjectId']
    ...
    def generate_report(self):
        ...
        print("\n" + "="*50)
        print("STROOP DATA INTEGRATION REPORT (HIGHSCHOOL)")
        print("="*50)
    ...
    def run_integration(self):
        ...
        データ統合プロセス全体を実行
        """
        print("Starting Stroop data integration process (Highschool)...")
        print("="*50)
...
if __name__ == "__main__":
    ...
    integrator = StroopDataIntegratorHighschool("data")
