...
class UFOVDataIntegratorHighschool:
    def __init__(self, data_dir="data"):
        """
        高校生向けUFOV（Useful Field of View）データをdata_masterに統合するクラス
    ...
    def preprocess_ufov_data(self):
        ...
        # 必要な列のみを抽出
        ufov_columns = ['subjectId', 'subtest1_threshold', 'subtest2_threshold', 'subtest3_threshold']
        ...
        # subjectIdでソート
        self.ufov_processed = self.ufov_processed.sort_values(['subjectId'])
    ...
    def generate_report(self):
        ...
        print("\n" + "="*50)
        print("UFOV DATA INTEGRATION REPORT (HIGHSCHOOL)")
        print("="*50)
    ...
    def run_integration(self):
        ...
        データ統合プロセス全体を実行
        """
        print("Starting UFOV data integration process (Highschool)...")
        print("="*50)
...
if __name__ == "__main__":
    ...
    integrator = UFOVDataIntegratorHighschool("data")
